...
const NewArrivals = () => {
  ...
  const updateScrollButtons = () => {
    ...
    if (container) {
      ...
      setCanScrollRight(rightScrollable); // Si le scrollLeft est supérieur à 0, on peut scroller vers la gauche. L'utilisateur a scrollé le contenu vers la droite et est donc capable de revenir en arrière. (cf explication 2:02:30)
    }
    ...
    <section>
      <div className="container mx-auto text-center mb-10 relative">
        ...
        <div className="absolute right-0 bottom-[-30px] flex space-x-2">
          <button
            onClick={() => scroll("left")}
            disabled={!canScrollLeft}                          // Disable button if no scroll left
